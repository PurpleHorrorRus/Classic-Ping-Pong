...
public class Render extends JPanel {
	...
	static Rectangle[] playerRectangle = new Rectangle[2];
	...
	protected void paintComponent(java.awt.Graphics g) {
		...
		playerRectangle[0].setLocation((int)Player.getX(0), (int)Player.getY(0));
		playerRectangle[1].setLocation((int)Player.getX(1), (int)Player.getY(1));
